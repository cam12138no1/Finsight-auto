...
export const COMPANIES: CompanyInfo[] = [
  ...
  { name: 'AppLovin', ticker: 'APP', category: 'AI_Applications', irUrl: 'https://investors.applovin.com/financials/', secCik: '0001708510', description: 'AI广告技术, 移动营销' },
  ...
  { name: 'Broadcom', ticker: 'AVGO', category: 'AI_Supply_Chain', irUrl: 'https://investors.broadcom.com/financials/', secCik: '0001649338', description: '网络芯片, 定制AI芯片' },
  ...
  { name: 'GE Vernova', ticker: 'GEV', category: 'AI_Supply_Chain', irUrl: 'https://www.gevernova.com/investors/financial-information', secCik: '0001974446', description: '电力设备, 能源转型' },
